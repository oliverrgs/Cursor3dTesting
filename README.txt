...
This is the readme for AdvancedGameTest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. AdvancedGameTest) > Ok.
...
- To run the project find AdvancedGameTest.java (which will be in under src/main/java/advancedgametest) and right click > Run 'AdvancedGameTest'
